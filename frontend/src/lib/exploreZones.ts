...
type ExploreZoneAmbience = LocationZone | "wind_forest";
...
export const EXPLORE_ZONES: ExploreZone[] = [
  ...
  { key: "forest", label: "森林", icon: "♣", kind: "forest", x: -118, z: 20, radius: 44, color: "#8ed08a", ambience: "wind_forest", dy: -12 },
...
export function exploreZoneAmbience(zone: ExploreZone | null, night: boolean): LocationZone | null {
  ...
  return zone.ambience === "wind_forest" ? "forest" : zone.ambience;
}
